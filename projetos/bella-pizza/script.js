...
const firebaseConfig = {
    apiKey: "AIzaSyDQvFPl5KrDNegbp-NxjlIrOk7RzN-xVto",
    authDomain: "pizzaria-9308d.firebaseapp.com",
    projectId: "pizzaria-9308d",
    storageBucket: "pizzaria-9308d.firebasestorage.app",
    messagingSenderId: "97394959316",
    appId: "1:97394959316:web:a95e22ee28d13b52616c41"
};
    ...
    onSnapshot(q, (snapshot) => {
        ...
        snapshot.forEach((doc) => {
            ...
            card.innerHTML = `
                ...
                <span class = "pizza prince"> R$ ${parseFloat(p.preco).toFixed(2)}</span>
